...
<div class="row">
    <div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
        <h1 class="page-title txt-color-blueDark">
            ...
            <?= __('System');?>
            <span> > <?= $this->Html->link(__('List Insurance Companies Mst'), ['action' => 'index'])?></span>
        </h1>
    </div>
</div>
    ...
    <article class="col-sm-12 col-md-12 col-lg-12">
        ...
        <div class="jarviswidget jarviswidget-color-darken" id="wid-id-0" data-widget-colorbutton="false" data-widget-editbutton="false">
            <header>
                ...
                <h2><h2><?= ($insurancecompanyMst->isNew())?__('Insurance Mst type add'):__('Insurance Mst type edit'); ?></h2></h2>
            </header>
            ...
            <div>
                ...
                <div class="widget-body">
                    ...
                    <?= $this->Form->create($insurancecompanyMst, ['id' => 'smart-form-register', 'class' => 'form-horizontal']) ?>
                    <fieldset>
                        ...
                        <div class="form-group">
                            <label class="col-md-3 control-label"><?= __('Value 01') ?></label>
                            <div class="col-md-4">
                                <?= $this->Form->input('value_01', ['required' => false, 'placeholder' => __('Value 01'), 'class'=>'form-control']); ?>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-3 control-label"><?= __('Value 02') ?></label>
                            <div class="col-md-4">
