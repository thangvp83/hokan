    ...
    <article class="col-sm-12 col-md-12 col-lg-12">
        ...
        <div class="jarviswidget jarviswidget-color-darken" id="wid-id-0" data-widget-colorbutton="false" data-widget-editbutton="false">
            <header>
                ...
                <h2><h2><?= ($deputytypeMst->isNew())?__('Deputy type Mst add'):__('Deputy type Mst edit'); ?></h2></h2>
            </header>
                ...
                <div class="widget-body">
                    ...
                    <fieldset>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <?= $this->Form->input('main_code', ['options' => $cate, 'empty' => array('0' => __('Parent')),'required' => false, 'placeholder' => __('Main Code'), 'class'=>'form-control']); ?>
                            </div>
                        </div>
                        <div class="form-group">
